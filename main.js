...
/* Creditos a santiyt65 (https://wa.me/542604604584) */
...
global.authFile = `TanjiroSession`;
...
//Código adaptado para la compatibilidad de ser bot con el código de 8 digitos. Hecho por: https://github.com/santiyt65
let opcion
if (methodCodeQR) {
opcion = '1'
}
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['GOGETA-BOT', 'Safari', '2.0.0'] : methodCodeQR ? ['GOGETA-BOT', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./TanjiroSession")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-') /*|| file.startsWith('session-') || file.startsWith('sender-') || file.startsWith('app-') */
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./TanjiroSession/${files}`)
})
} 
...
const directories = ['./TanjiroSession/', './jadibts/']
...
if (reason == 405) {
await fs.unlinkSync("./TanjiroSession/" + "creds.json")
