...
const render = async ({
  wid = '',
  pp = toBase64(readFileSync(join(src, 'bienvenida2.png')), 'image/png'),
  name = '',
  title = '',
  text = '',
  background = toBase64(readFileSync(join(src, 'bienvenida', 'Aesthetic_000.jpeg.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
